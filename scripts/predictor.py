...
Usage (defaults are safe):
  python predictor_hybrid_strict_adn.py \
    --seed 1000000000000066600000000000001 \
    --ap 3 5 7 11 \
    --lane 3,7 5,11 \
    --K0 9 --c 2.0 --alpha 1.0 --max-expands 5 \
    --out-prefix predictor_1e10

Or pin an exact anchor prime:
  python predictor_hybrid_strict_adn.py --P1 1000000000000066600000000000001  
"""
...
def main():
    ...
    g.add_argument("--seed", type=int, default=1000000000000066600000000000001,
    ...
    p.add_argument("--out-prefix", type=str, default=None, help="Prefix for CSV files")
